...
if(Kohana::$environment == Kohana::DEVELOPMENT) {
	...
	//生产服务器下的日志和cache
	$log = isset($_SERVER['APPLOGS_DIR']) ? $_SERVER['APPLOGS_DIR'] : '/data0/www/applogs/';
	$cache = isset($_SERVER['CACHE_DIR']) ? $_SERVER['CACHE_DIR'] : '/data0/www/cache/';
}
 ...
 */
Kohana::$log->attach(new Log_File($log));
...
Kohana::modules(array(
	...
	'bll'		=>	MODPATH.'bll',	 // bll 
	'misc'		=>	MODPATH.'misc',	 // misc
	'biz'		=>	BIZPATH,	 //biz 
	'inherit'	=>  EXTPATH.'inherit',
	'helper'	=>  EXTPATH.'helper',
