      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-content nopadding">
            <form class="form-horizontal" id="validate-form" role="form" method="post" action="/manager/save">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="type" class="form-control" name="type" onclick="Manager.staffTypeSwitch(this);">
                            <option value="<?php echo Dao_Manager::TYPE_FULLTIME ;?>">正式员工</option>
                            <option value="<?php echo Dao_Manager::TYPE_INTERN ;?>">实习生</option>
                            <option value="<?php echo Dao_Manager::TYPE_PARTTIME ;?>">兼职</option>
                            <option value="<?php echo Dao_Manager::TYPE_PARTNER ;?>">合作方</option>
                        </select>
                    </div>
                </div>
                <div id="staffIdArea" class="control-group">
                    ...
                    <div class="controls">
                        <input id="staff_id" class="form-control" name="staff_id" type="text">
                    </div>
                </div>
                <div class="control-group">
