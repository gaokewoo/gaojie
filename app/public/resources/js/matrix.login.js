    ...
    $.ajax({    
        ...
        success:function(data) {
            ...
            if (data.code == 1) {
                ...
                //showDialog("登录信息","<span style='color:red;'>" + data.messages + "</span>");
		$("#errorMsg").text(data.messages);
            }else{
                //showDialog("登录信息","<span style='color:red;'>抱歉，你的账号非管理员，不能登录！</span>");
		$("#errorMsg").text('抱歉，你的账号非管理员，不能登录！');
            }
        },    
        error : function() {}    
    });
...
$(document).ready(function(){
    ...
    $("#changePwd").click(function(){
        ...
        $.ajax({    
            ...
            success:function(data) {
                if (data == 1) {
                    showDialog("重置密码信息","<span style='color:red;'>你好，密码重置成功，请返回登录！</span>");
                }else if(data==0){
